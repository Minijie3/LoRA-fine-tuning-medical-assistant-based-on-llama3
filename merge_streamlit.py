...
# 定义模型路径        这里还需要完成路径填写
mode_name_or_path = '/root/autodl-tmp/llama3_test/LLM-Research/Meta-Llama-3___1-8B-Instruct'
lora_path = '/root/autodl-tmp/llama3_test/output/llama3_1_instruct_lora/checkpoint-1000' #lora的checkpoint路径
